...
var UserController = function () {
    ...
    _createClass(UserController, [{
                ...
                this._userService.getShopInfo().then(function (data) {
                    if (data) {
                        ...
                        if (data.store.individual.document.citizenCard) {
                            _this5.image.individual.citizenCard = "" + _this5._CONFIG.PATH.APIS + data.store.individual.document.citizenCard;
                        }
                        if (data.store.individual.document.homeRegister) {
                            _this5.image.individual.homeRegister = "" + _this5._CONFIG.PATH.APIS + data.store.individual.document.homeRegister;
                        }
                        if (data.store.company.document.companyCertificate) {
                            _this5.image.company.companyCertificate = "" + _this5._CONFIG.PATH.APIS + data.store.company.document.companyCertificate;
                        }
                        if (data.store.company.document.tradeRegister) {
                            _this5.image.company.tradeRegister = "" + _this5._CONFIG.PATH.APIS + data.store.company.document.tradeRegister;
                        }
        ...
        value: function uploadStoreDocument(businessType, documentName) {
            ...
            this._userService.uploadFile(this.file[businessType][documentName]).then(function (data) {
                _this8.signupInfo.store[businessType].document[documentName] = data.src;
                _this8.image[businessType][documentName] = "" + _this8._CONFIG.PATH.APIS + data.src;
            }, function (error) {
                alert(error.message);
            });
        }
        ...
        value: function updateAddressDocumentDropValues() {
            ...
            if (this.signupInfo.address.isDocumentDropSamePickup) {
                ...
                $.each(this.signupInfo.address.documentDrop, function (field, value) {
                    _this9.signupInfo.address.documentDrop[field] = _this9.signupInfo.address.pickup[field];
                });
            }
        }
    }, {
        ...
        value: function getProvinces(addressType, queries) {
            ...
            this._userService.getProvinces(queries).then(function (data) {
                _this10.provinces[addressType] = data;
                if (!isDefineQueries) {
                    if (_this10.provinces[addressType].length == 1) {
                        _this10.signupInfo.address[addressType].province = _this10.provinces[addressType][0];
                        _this10.getAmphurs(addressType);
                    }
                }
            }, function (error) {
                alert(error.message);
        ...
        value: function getAmphurs(addressType, queries) {
            ...
            this._userService.getAmphurs(queries).then(function (data) {
                _this11.amphurs[addressType] = data;
                if (!isDefineQueries) {
                    if (_this11.amphurs[addressType].length == 1) {
                        _this11.signupInfo.address[addressType].amphur = _this11.amphurs[addressType][0];
                        _this11.getDistricts(addressType);
                    }
                }
            }, function (error) {
                alert(error.message);
        ...
        value: function getDistricts(addressType, queries) {
            ...
            this._userService.getDistricts(queries).then(function (data) {
                _this12.districts[addressType] = data;
                if (!isDefineQueries) {
                    if (_this12.districts[addressType].length == 1) {
                        _this12.signupInfo.address[addressType].district = _this12.districts[addressType][0];
                    }
                }
            }, function (error) {
                alert(error.message);
